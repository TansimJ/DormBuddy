                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          const SizedBox(height: 4),
                          Text("Dorm Type: ${property['dormType']}"), //added the dorm type
                          const SizedBox(height: 4),
                          Text("Posted by: ${property['postedBy']}"), //added the posted by
                          const SizedBox(height: 4),
                          Text("Price: \$${property['price']}"), //added the price
                        ],
                      ),
                    ),
                  );
